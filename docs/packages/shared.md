...
The Shared package ensures consistency across the entire Viwo ecosystem by providing a single source of truth for critical types and utility functions. This prevents discrepancies between the client and server.
