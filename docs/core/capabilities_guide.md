...
Viwo uses a **capability-based security** model to control access to sensitive operations like file I/O, network requests, and system resources. This guide explains how capabilities work and how to use them effectively.
...
- [Security](security.md) - Overview of Viwo's security model
