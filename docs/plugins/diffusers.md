...
The Diffusers Plugin provides Stable Diffusion image generation capabilities for viwo through a capability-based access control system. It enables text-to-image generation using various Stable Diffusion models via a Python inference server.
