...
export function seed() {
  ...
  addVerb(
    ...
    Std["seq"](
      ...
      Std["let"](
        ...
        Std["lambda"](
          ...
          Std["seq"](
            Std["let"](
              "entityVerbs",
              Core["verbs"](Core["entity"](Std["var"]("entityId"))),
            ),
            Std["for"](
              "v",
              Std["var"]("entityVerbs"),
              Std["seq"](
                ...
                Std["if"](
                  Boolean["not"](
                    Object["obj.has"](Std["var"]("seen"), Std["var"]("key")),
                  ),
                  Std["seq"](
                    Object["obj.set"](
                      Std["var"]("seen"),
      ...
      Std["apply"](
        Std["var"]("addVerbs"),
        Object["obj.get"](Std["var"]("player"), "id"),
      ),

      // 2. Room verbs
      Std["let"](
        "locationId",
        Object["obj.get"](Std["var"]("player"), "location"),
      ),
      Std["if"](
        Std["var"]("locationId"),
        Std["seq"](
      ...
      List["list.find"](
        ...
        Std["lambda"](
          ...
          Std["seq"](
            Std["let"](
              "props",
              Core["resolve_props"](Core["entity"](Std["var"]("id"))),
            ),
            Boolean["=="](
              Object["obj.get"](Std["var"]("props"), "name"),
              Std["var"]("query"),
            ),
          ),
        ),
        ...
        Std["seq"](
          ...
          Std["if"](
            ...
            Std["seq"](
              Std["let"](
                "exitId",
                Core["call"](Std["this"](), "find_exit", Std["var"]("arg")),
              ),
              Std["if"](
                Std["var"]("exitId"),
                Std["let"](
            ...
            Std["seq"](
              ...
              Std["if"](
                ...
                Std["seq"](
                  Std["let"](
                    "oldLocId",
                    Object["obj.get"](Std["var"]("mover"), "location"),
                  ),
  ...
  addVerb(
    entityBaseId,
    "say",
    Std["send"]("message", "Say is not yet implemented."),
  );
  ...
  addVerb(
    ...
    Std["if"](
      ...
      Std["seq"](
        ...
        Std["let"](
          "exits",
          Object["obj.get"](Std["var"]("room"), "exits", List["list.new"]()),
        ),
        Std["let"](
          "resolvedContents",
          List["list.map"](
      ...
      Std["seq"](
        ...
        Std["let"](
          "targetId",
          Core["call"](Std["caller"](), "find", Std["var"]("targetName")),
        ),
        Std["if"](
          Std["var"]("targetId"),
          Std["seq"](
            Std["let"](
              "target",
              Core["resolve_props"](Core["entity"](Std["var"]("targetId"))),
            ),
            Std["send"](
              "update",
              Object["obj.new"]([
  ...
  addVerb(
    ...
    Std["seq"](
      ...
      Std["let"](
        "finalList",
        List["list.concat"](
          List["list.new"](Std["var"]("player")),
          Std["var"]("resolvedItems"),
        ),
      ),
      Std["send"](
        "update",
  ...
  addVerb(
    ...
    Std["seq"](
      ...
      Std["let"](
        "roomName",
        Str["str.join"](List["list.slice"](Std["args"](), 1), " "),
      ),
      Std["if"](
        ...
        Std["seq"](
          ...
          Std["if"](
            ...
            Std["seq"](
              ...
              Std["send"](
                "message",
                Str["str.concat"]("You create ", Std["var"]("name"), "."),
              ),
              Core["call"](Std["caller"](), "look"),
              // Return item ID
              Std["var"]("itemId"),
    ...
    Std["seq"](
      ...
      Std["if"](
        ...
        Std["seq"](
          Std["let"](
            "targetId",
            Core["call"](Std["this"](), "find", Std["var"]("targetName")),
          ),
          Std["if"](
            Std["var"]("targetId"),
            Std["seq"](
  ...
  addVerb(
    watchId,
    "tell",
    Std["send"]("message", Time["time.format"](Time["time.now"](), "time")),
  );
  ...
  addVerb(
    ...
    List["list.get"](
      ...
      Math["random"](
        0,
        Math["-"](
          List["list.len"](Object["obj.get"](Std["this"](), "colors")),
          1,
        ),
      ),
    ),
    ...
    Std["seq"](
      ...
      Core["set_entity"](
        Object["obj.set"](
          ...
          "adjectives",
          List["list.new"](
            Str["str.concat"]("color:", Std["var"]("newColor")),
            "material:silver",
          ),
        ),
      ),
